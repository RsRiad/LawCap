  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      ...
      <p className="sm:w-1/3 text-center text-sm">
        Browse through our extensive list of trusted lawyers.
      </p>
      ...
      <button
        ...
        className="bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10 hover:scale-105 transition-all text-sm font-medium"
      >
        more
      </button>
    </div>
